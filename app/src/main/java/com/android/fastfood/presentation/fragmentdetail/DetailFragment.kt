...
class DetailFragment : Fragment() {
    ...
    private fun inDecreaseTotal() {
        ...
        increase.setOnClickListener{
            ...
            textTotalPrice.text = getString(R.string.string_buy, totalBuy.toInt())
        }
    ...
    private fun viewDetail() {
        foodMenu?.let {
            binding.apply {
                ivFoodMenu.load(it?.imgUrl){
                    crossfade(true)
                }
                tvMenuName.text = it?.name
                ...
                btnBuy.text =
                    getString(R.string.string_buy, it?.price?.toInt())
            }
        }
